...
export const BookingForm = () => {
  ...
  const nextStep = () => {
    ...
    if (step === 2 && !formData.service_type) {
  ...
  return (
    <div className="space-y-6">
            ...
            {step === 2 && (
              <div className="space-y-4">
                ...
                {formData.service_type && (
                  <ServicePricing selectedServiceType={formData.service_type} compact={true} />
                )}
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Optional - helps with pricing estimate"
                  />
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm text-blue-700 space-y-1">
                    ...
                    {formData.estimated_weight && (
                      <p><strong>Est. Weight:</strong> {formData.estimated_weight} lbs</p>
                    )}
                  </div>
                </div>
      ...
      {/* Show full pricing information when not in booking flow */}
      {step === 2 && formData.service_type && (
        <ServicePricing selectedServiceType={formData.service_type} />
      )}
    </div>
  );
};
